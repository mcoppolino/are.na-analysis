...
def parse_args():
    ...
    parser.add_argument('-connection_csv', help='path to connections csv file to be written to', default='csv/connections.csv')
...
def main():
    ...
    connections_iterator = channels_connections_iterator(channels_csv_fp, )
